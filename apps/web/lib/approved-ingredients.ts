...
export const APPROVED_INGREDIENTS: ApprovedIngredient[] = [
  ...
  // ── MEIERI ──────────────────────────────────────────────────────────────────
  { aiName: 'proteinyoghurt',   displayName: 'Yt Proteinyoghurt',        calories_per_100g: 67,  protein_per_100g: 9.2, carbs_per_100g: 3.2, fat_per_100g: 1.8, category: 'meieri' },
  ...
  { aiName: 'proteinmelk kakao', displayName: 'Yt Proteinmelk Kakao',   calories_per_100g: 46,  protein_per_100g: 6,   carbs_per_100g: 4.8, fat_per_100g: 0.2, category: 'meieri' },
...
const ALIASES: Record<string, string> = {
  ...
  'smøreost':           'kremost',
  'yt proteinyoghurt':    'proteinyoghurt',
  'ytt proteinyoghurt':   'proteinyoghurt',
  'yt':                   'proteinyoghurt',
  'ytt':                  'proteinyoghurt',
  'yt proteinmelk':        'proteinmelk',
  'yt proteinmelk kakao':  'proteinmelk kakao',
